...
<div class="single-pagetitle streched-template" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>)">
    <div class="wrap">
	   <div class="category-wrap">
            ...
            foreach ( $terms as $term ) {
                ...
                if($term->slug != "featured-article"){
                    echo '<p class="category"><span><a class="" href="javascript:void(0);" style="cursor: unset;">' . $term->name . '</a></span></p>';
                }
    ...
    <span class="wrap">
        ...
        ?>
            <?php if (!empty($illustrator)) { ?>
                <span class="illustrator">Photo illustration: <?= $illustrator; ?>;</span>
            <?php } ?>
    ...
    <?php endif ?>
    	...
    	<div id="primary" <?php astra_primary_class(); ?>>
    		...
    		<div class="content-header">
    		    ...
    		    <p class="custom-meta">By <span class="author"> <?= $author ?> </span>|<span class="date"> <?= $date ?> </span>|<span class="time"><?= $time ?></span></p>
